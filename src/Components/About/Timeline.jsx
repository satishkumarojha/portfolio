        ...
        <VerticalTimeline lineColor={linecolor}>
          ...
          >
            <h3
              ...
              data-aos="fade-right"
            >
              Student [B.Tech. (Electronics and Instrumentation Engineering)]
            </h3>
            <h4
              className="vertical-timeline-element-subtitle"
              data-aos="fade-right"
            ...
            <p data-aos="fade-right">
              Pursued Electronics and Instrumentation Engineering with a specialization in Computer Technology.
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
